...
<button type="button" class="Btn" aria-disabled="true" disabled>Disabled button</button>
...
<button type="button" class="Btn Btn--s" aria-disabled="true" disabled>Small disabled button</button>
...
<button type="button" class="Btn Btn--s Btn--outline Btn--circle">
...
<div class="BtnGroup">
  ...
  <button type="button" class="Btn Btn--outline">Button B</button>
  <button type="button" class="Btn Btn--outline">Button C</button>
</div>
<div class="BtnGroup">
  <button type="button" class="Btn Btn--s Btn--primary Btn--outline" disabled>Button A</button>
  <button type="button" class="Btn Btn--s Btn--primary Btn--outline" disabled>Button B</button>
  <button type="button" class="Btn Btn--s Btn--primary Btn--outline" disabled>Button C</button>
</div>
```
